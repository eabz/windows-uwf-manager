...
AppId={{A3543A39-4982-4116-B086-427771B78642}
AppName={#MyAppName}
...
OutputDir=Installer
OutputBaseFilename=UwfManagerSetup
Compression=lzma
...
[Files]
; Point this to the output of your 'dotnet publish' command.
; Ensure you run the publish command BEFORE compiling this script.
Source: "UwfManager\bin\Release\net8.0-windows\win-x64\publish\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
